...
- **KMS, WAF, Shield, GuardDuty, Inspector, Macie**: [`Security-KMS-WAF-Shield-GuardDuty.md`](../../detailed-reference/Security-KMS-WAF-Shield-GuardDuty.md)
- **Advanced security (SAP level)**: [`SAP-04-Security.md`](../../detailed-reference/SAP-04-Security.md)
- **CloudTrail, Config, monitoring integration**: [`Monitoring-CloudWatch-CloudTrail-Config.md`](../../detailed-reference/Monitoring-CloudWatch-CloudTrail-Config.md)
